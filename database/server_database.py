...
from sqlalchemy import PrimaryKeyConstraint, create_engine, Table, Column, Integer, String, MetaData, ForeignKey, DateTime
import sys
import os
import datetime
...
class ServerDB:
    ...
    def __init__(self):
        ...
        # If there are records in the active users table, then they must be deleted
